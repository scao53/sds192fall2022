...
* Join the `#sds-192-midterms` channel on Slack and post all questions there.
* What to study:
    + Lecture notes: both "chalk talk" and lecture slides. 
    + Problem sets and solutions.
    + ModernDive readings and learning checks, MDSR readings.
    + Practice midterm posted on `#sds-192-midterms` channel on Slack, which we'll go over on Friday.
