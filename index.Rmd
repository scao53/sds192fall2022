...
* MP1:
    ...
    + Post questions about MP1 in `#sds-192-mp1` on Slack
...
* Mini-project 1 (MP1) assigned on Monday
    + Slack demo of how to subscribe to a `#channel`: Adding yourselves to the `#sds-192-mp1` channel. Please ask all questions about MP1 there
    + You will be assigned groups for MP1, MP2, and MP3. You can choose your groups for the final project.
    + By Sunday 5pm I will post the groups (of two) in the `#sds-192-mp1` channel. Until `#sds-192-mp1` is due, **you will sit next to your partner in class**.
    + Please reach out to your partner with a Slack DM before Monday's lecture to coordinate meeting before lecture so you can sit next to each other.
