...
<iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTBbD2Qk0QBwwadcmSHVsJgAgIPs3_2AJ_BTphoE6u8fhV_pxS0qNmV1cG5JY8INK_wbnpaTEFkyemV/pubhtml?gid=0&single=true" width="100%" height="850"></iframe>
...
* Final project in groups of 2-3 will be assigned on Wednesday and due Fri 12/21 2pm (last day of exams). You can choose your group
* PS07 posted
...
1. Go over solutions to <code>examples.Rmd</code> -&gt; Section 1 on “Converting data frames to sf objects”
...
* Download <a href="static/projects/MP3/MP3.zip" download><code>MP3.zip</code></a>
* Move <code>MP3.zip</code> to your SDS192 folder on your computer
* Unzip <code>MP3.zip</code>. Windows users: be sure to “Extract all”
* In the resulting MP3 folder, double-click the RStudio Project <code>MP3.Rproj</code> icon<br />
<img src="static/images/MP2.png" width="100" /><br />
* Verify that RStudio opens with MP3 written in the top-right<br />
<img src="static/images/MP2_2.png" width="100" />


### 1. Chalk talk

1. Example solutions to `examples.Rmd` Section 1 exercise. Code posted in `#sds-192-mp3`; screencast below
1. Shapefiles
<!--
...
* In MP3 folder -&gt; <code>examples.Rmd</code> -&gt; Section 1 on “Converting data frames to sf objects”, do exercises
...
### 2. Lecture
* <a href="https://scao53.github.io/sds192fall2022/slides/Lec26-Introtomapping.html">Class slides: Intro to Mapping
