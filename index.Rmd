...
* With your MP4 partner, practice using SQL in R Markdown! Complete MDSR 15.8 Exercises Problem 9: Using the <code>lahman</code> package (See <a href="https://en.wikipedia.org/wiki/Baseball_statistics" target="_blank">https://en.wikipedia.org/wiki/Baseball_statistics</a> for explanations of any acronyms)
