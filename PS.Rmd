...
* Download the following zip file: <a href="PS/PS06.zip" download>`PS06.zip`</a>.
* Move `PS06.zip` to your SDS192 folder on your computer.
* Unzip `PS06.zip`. Windows users: be sure to "Extract all".
* In the resulting PS06 folder, double-click the RStudio Project `PS06.Rproj` icon. For this PS you should **always** work in "PS06" RStudio Project mode.

Submission:

* You will only be submitting the resulting `PS06.pdf` file on moodle. Please use the "Knit to PDF" method directly, instead of "Knit to Word" and then save to PDF method.
...
*Due Monday 10/24 9pm*

## 1. R Markdown component {#PS05_R}

* Download the following Rmd template file: <a href="PS/PS05.Rmd" download>`PS05.Rmd`</a>.
* You will be submitting the resulting `PS05.pdf` file on moodle. Please use the "Knit to PDF" method directly, instead of "Knit to Word" and then save to PDF method.
* If you encounter issues knitting your document, consult the [6 R Markdown Fixes](https://docs.google.com/document/d/1P7IyZ4On9OlrCOhygFxjC7XhQqyw8OludwChz-uFd_o/){target="_blank"}.
* Submit on moodle:
    1. For each questions, tag **all** pages of your PDF that relate to that question (not just the first).
    1. You will be asked to tag the honor code question as well.
...
*Due Monday 10/17 9pm.*

## 1. R Markdown component {#PS04_R}

* Download the following Rmd template file: <a href="static/PS/PS04.zip" download>`PS04.zip`</a>.
* You will be submitting the resulting `PS04.pdf` file on moodle. Please use the "Knit to PDF" method directly, instead of "Knit to Word" and then save to PDF method.
...
*Due Wednesday 10/12 9pm.*

## 1. R Markdown component {#PS03_R}

* Download the following Rmd template file: <a href="PS/PS03.Rmd" download>`PS03.Rmd`</a>.
* You will be submitting the resulting `PS03.pdf` file on moodle. Please use the "Knit to PDF" method directly, instead of "Knit to Word" and then save to PDF method.
* Complete the individual questions. Knit early, knit often.
* If you encounter issues knitting your document, consult the [6 R Markdown Fixes](https://docs.google.com/document/d/1P7IyZ4On9OlrCOhygFxjC7XhQqyw8OludwChz-uFd_o/){target="_blank"}.
* Submit on moodle:
    1. For each questions, tag **all** pages of your PDF that relate to that question (not just the first).
...
* Download the following Rmd template file: <a href="PS/PS02.Rmd" download>`PS02.Rmd`</a>.
* You will be submitting the resulting `PS02.pdf` file on moodle. There are two methods to create a PDF:
...
1. Submit a PDF of your syllabus quiz responses on moodle.
