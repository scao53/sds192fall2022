...
# Adjusting the Scale
ggplot(data = hampshire_census_data, 
       aes(x = COMMUNITY,y = CEN_WORKERS)) +
  geom_point() +
  coord_flip() + # Flipping the x and y coordinates here makes the labels more legible.
  scale_y_log10() +
  labs(title = "Number of Workers Age 16+ in Hampshire County MA, 2018", x = "COMMUNITY", y = "WORKERS AGE 16+")
```
...
ggplot(data = pioneer_valley_census_data, 
  ...
  geom_point() +
  facet_wrap(~CEN_EARLYED,nrow=2) + # Faceting
  coord_flip() + # Flipping the x and y coordinates here makes the labels more legible.
  scale_y_log10() +
