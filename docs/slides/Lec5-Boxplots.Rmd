...
# Interpreting Boxplots Step 3: Compare the ranges
...
# Interpreting Boxplots Step 4: Compare the IQRs
...
* Still use the Spotify data as we did in the previous lecture.
...
* Copy client id and secret from your previous in-class exercise into the chunk below, and then run the code chunk.
