...
In this exercise, you're going to recreate the figure from Practice Midterm I Question 4 (see `#sds-192-midterms` channel in Slack), allowing us to visualize the extent to which the names "Casey" and "Riley" were used for babies of both sex male and female.
...
In this exercise, you're going to recreate the figure from Practice Midterm I Question 4 (see `#sds-192-midterms` channel in Slack). This time however, you're going to limit it to years 1960 and later:
